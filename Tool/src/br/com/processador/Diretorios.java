	...
	public void listarDirs(String caminho) {
		...
		for (int i = 0; i < listaArquivos.length; i++) {
			...
			if (listaArquivos[i].isDirectory()) {
				...
				/*
				 * else if (caminhoCompleto.contains("/src")) { dirsSRC.add(caminho + "/" +
				 * listaArquivos[i].getName()); System.out.println(caminho + "/" +
				 ...
				 */
					...
					if (caminhoCompleto.contains("src") && caminhoCompleto.contains("java")) {
